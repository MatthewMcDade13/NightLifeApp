...
(function (app) {
    ...
    (function (controllers) {
        var NavbarController = (function () {
            function NavbarController($scope, AppHttpService) {
                this.$scope = $scope;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.http.getCurrentUser()];
                            case 1:
                                userResponse = _a.sent();
                                this.$scope.$apply(function () {
                                    _this.currentUser = userResponse;
                                });
                                return [2 /*return*/];
                        }
                    });
            ...
            NavbarController.prototype.getUserIsAuthenticated = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var _this = this;
                    var authResponse;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                this.$scope.$apply(function () {
                                    _this.isUserLoggedIn = authResponse;
                                });
                                return [2 /*return*/];
                        }
                    });
        ...
        NavbarController.$inject = ["$scope", "AppHttpService"];
