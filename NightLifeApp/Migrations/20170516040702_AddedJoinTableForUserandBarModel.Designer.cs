...
namespace NightLifeApp.Migrations
{
    ...
    [Migration("20170516040702_AddedJoinTableForUserandBarModel")]
    partial class AddedJoinTableForUserandBarModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NightLifeApp.Models.RSVP", b =>
                {
                    b.Property<int>("BarId");

                    b.Property<string>("NightLifeUserId");

                    b.HasKey("BarId", "NightLifeUserId");
            ...
            modelBuilder.Entity("NightLifeApp.Models.RSVP", b =>
                {
                    b.HasOne("NightLifeApp.Models.Bar", "Bar")
                        .WithMany("RSVPs")
                        .HasForeignKey("BarId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NightLifeApp.Models.NightLifeUser", "NightLifeUser")
                        .WithMany("RSVPs")
